...
/**
 * 3-tuple that represents the state of a source file at a point in time:
 * <ul>
 *     <li>a fully-qualified class name</li>
 *     <li>a path to the source file</li>
 *     <li>a hash of the contents of the source file</li>
 * </ul>
 */
public class SourceFileSnapshot {

    private static final Logger LOGGER = LogManager.getLogger(SourceFileSnapshot.class);
     ...
     * @param sourceFileHash the MD5 hash of the content of the class file (e.g., YA9ExftvTDku3TUNsbkWIw==)
     */
    public SourceFileSnapshot(FullyQualifiedClassName fullyQualifiedClassName, Path sourceFile, Path classFile, String sourceFileHash, String classFileHash) {
    ...
    /**
     * Returns true if the source file has changed, false otherwise.
     */
    ...
    /**
     * Returns true if the class file has changed, false otherwise.
     */
