...
public class ClassFileContainerTest {
    ...
    void testParse() {
        ...
        assertEquals("com.example.LeftPadder", classFileContainer.getById("0").getClazz());
        assertEquals("com.example.LeftPadderTest", classFileContainer.getById("1").getClazz());
